...
class WordCountPlugin{
   ...
   function register_word_count_settings(){
    ...
    add_settings_section( 'wcp_section_1', '<hr/>', array($this, 'section_1_content'), $word_count_plugin_slug );
    ...
    add_settings_field( 'wcp_word_count', 'Word Count', array($this,'wcp_checkbox_handler'), $word_count_plugin_slug, 'wcp_section_1', array('fieldName'=> 'wcp_word_count'));
    add_settings_field( 'wcp_character_count', 'Character Count', array($this,'wcp_checkbox_handler'), $word_count_plugin_slug, 'wcp_section_1', array('fieldName'=> 'wcp_character_count'));
    add_settings_field( 'wcp_read_count', 'Read Time', array($this,'wcp_checkbox_handler'), $word_count_plugin_slug, 'wcp_section_1',array('fieldName'=> 'wcp_read_count'));
   ...
   function section_1_content(){
    ?>
    <h4 style="margin:0">Primary settings</h4>
    <?php 
    }
